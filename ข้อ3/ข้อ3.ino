...
void setup() {
  motor1.setSpeed(-128);   // Motor 1 runs forward at 100% speed.
  motor2.setSpeed(-128);  // Motor 2 runs backward at 100% speed.
...
void loop() {
  ...
  motor2.setSpeed(0);  // Motor 2 runs backward at 100% speed.
